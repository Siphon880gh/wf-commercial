...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Brand Color System for Technical Authority
        brand: {
        ...
        healthcare: {
          ...
          "teal-foreground": "var(--healthcare-teal-foreground)",
        },
        success: {
          green: "var(--success-green)",
          "green-foreground": "var(--success-green-foreground)",
        },
        education: {
          purple: "var(--education-purple)",
          "purple-foreground": "var(--education-purple-foreground)",
        },
        warning: {
          orange: "var(--warning-orange)",
          "orange-foreground": "var(--warning-orange-foreground)",
        },
